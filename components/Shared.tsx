      ...
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-[1920px] mx-auto px-6 md:px-10 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button onClick={() => onNavigate(Page.SHOP, { category: 'New Arrivals' })} className="text-lg font-medium hover:text-gray-500 transition-colors">New Arrivals</button>
            <button onClick={() => onNavigate(Page.SHOP, { category: 'Agbadas' })} className="text-lg font-medium hover:text-gray-500 transition-colors">Agbadas</button>
            <button onClick={() => onNavigate(Page.SHOP, { category: 'Jalabiyas' })} className="text-lg font-medium hover:text-gray-500 transition-colors">Jalabiyas</button>
            <button onClick={() => onNavigate(Page.SHOP, { category: 'Caps' })} className="text-lg font-medium hover:text-gray-500 transition-colors">Caps</button>
            <button onClick={() => onNavigate(Page.SHOP, { category: 'Fabrics' })} className="text-lg font-medium hover:text-gray-500 transition-colors">Fabrics</button>
            <button onClick={() => onNavigate(Page.JOURNAL)} className="text-lg font-medium hover:text-gray-500 transition-colors">Journal</button>
          </nav>
